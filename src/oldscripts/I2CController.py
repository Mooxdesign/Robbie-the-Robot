...
if __name__=='__main__':
    controller = I2CController(0x40, debug=False)
    controller.setPWMFreq(50)
    controller.Set_Pulse(2,600)
    sleep(1)
    controller.Set_Pulse(2,1600)
    sleep(1)
    controller.Set_Pulse(2,2600)
    sleep(1)
    controller.Set_Pulse(2,1600)
    sleep(1)
    controller.Set_Pulse(2,600)
    ...
    #         controller.Set_Pulse(2,i)   #setting 15th pin of the servo header(forward direction)
    #         controller.Set_Pulse(5,i)
    #         sleep(0.2)
    
    #     for i in range(2500,500,-10):
    #         controller.Set_Pulse(2,i)   #setting 15th pin of the servo header(backward direction)
    #         controller.Set_Pulse(5,i)
    #         sleep(0.2)  
